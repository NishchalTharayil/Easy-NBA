...
<div class="container">
    <div class="title">Enter The Students</div>
    <div class="content">
    <form action="..\upload\uploadstu.php" method="POST">
        <div class="user-details">
          <div class="input-box">
            <span class="details">Enter The USN</span>
            <input type="text" class="input" name="usn" placeholder="ex: 4GMxxCSxxx" required="required"><br><br>
          </div>
          <?php
...
<h2 style="margin-left:30px;"><label>Upload Excel file here:</label></h2>
  <br />	
  <a href="../excelforstu.php"><button name="import" type="submit" class="exbtn">ClickHere</button></a>
...
<div class="w3-show-inline-block">
  <div class="w3-bar">
    <a href="../view/viewstu.php"><button class="w3-btn w3-black">View Students</button></a>
   </center> 
  </div>
  </div>
</div>
