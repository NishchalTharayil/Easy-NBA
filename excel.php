...
<div class="container">
 <div class="title">Upload Excel File for Marks</div>
  <div class="content">
...
<center><br>
    <div class="collapse" id="navbarToggleExternalContent" style="width:80%";>
        <div class="bg-dark p-4" >
          ...
          <img src="images/excel.jpg" width="550">
          <p style="color:#fff;" align="left"> * Note:<br>
          ->Data is start from first row.<br>
          ->There is no HeadLines.<br>
          ->cell A='Scheme_ID',B='Batch_id',C='Year_ID',D='SubCode'.<br>
          ->cell E='USN',F to J='CO1-CO5',K='External'.<br>
          ->*No empty cell between data it will throw Error.<br>
          ->Before Adding usn in Excel you should register USN </p>
        </div>
      </div>
...
foreach($reader as $key => $row){
    ...
    $co5=$row[9];
    $external=$row[10];
    mysqli_query($conn,"insert into marks values('$schemaId','$bid','$yearId','$subcode','$usn','$co1','$co2','$co3','$co4','$co5','$external')");
}
echo 
" <script>
alert('successfully Imported');
document.location.href='view/viewsubmarks.php';
</script>";
}
?>
